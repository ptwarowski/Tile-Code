...
<>
  ...
  <div className='planBox'>
    ...
    <>
      <p>Set tile position: x is <span>{positionArr[wallNumber][0]}</span> and y is <span>{positionArr[wallNumber][1]}</span> from left-bottom corner</p>
      <div className='sliders'>
        <input type="range" step={1} id="volumeX" name="positionX" value={positionArr[wallNumber][0]}
        min={0} max={tile.width} onChange={(x)=>onXPositionChange(x)}></input>
