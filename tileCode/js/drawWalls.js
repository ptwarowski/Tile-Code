...
for (let i=0; i<myStorage.length; i++)
    {
        ...
        if (label[0] == "s") {
          ...
          options.push(option);
          planArray = [...planArray, JSON.parse(myStorage[myStorage.key(i)]).arrayToSave];
          svgViewBoxArr = [...svgViewBoxArr, JSON.parse(myStorage[myStorage.key(i)]).svgViewBox];
        }  
